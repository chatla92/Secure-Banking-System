...
public class HomeController {
	...
	public String welcome(Model model) {
		...
		InternalUser user = dao.get(123, "emp_id");
		//getTransactions is by join of Transactions and InternalUser table for emp_id =123
		System.out.println(user.getTransactions().get(0).getTrans_id());
		...
		// ClassPathXmlApplicationContext("users-bean.xml");
		// InternalUserImpl obj = ctx.getBean("userDao",
		// InternalUserImpl.class);
		...
		// user.setZipcode("85281");
		// user.setContact_no("4804101771");
		// ClassPathXmlApplicationContext ctx1 = new
		// ClassPathXmlApplicationContext("users-bean.xml");
		// ExternalUserImpl obj1 = ctx.getBean("externaluserDao",
		// ExternalUserImpl.class);
		// obj1.save(user);
		...
		// acc.setUser_id(123);
		// ClassPathXmlApplicationContext ctx3 = new
		// ClassPathXmlApplicationContext("users-bean.xml");
		...
		// Authorization_Internal authorizeInternal=new
		...
		// ClassPathXmlApplicationContext ctx1 = new
		// ClassPathXmlApplicationContext("users-bean.xml");
		// AuthorizeInternalDao obj1 = ctx1.getBean("authorizeInternalDao",
		// AuthorizeInternalDao.class);
		// obj1.saveOrUpdate(authorizeInternal);
		// Authorization_Internal internalAuth = obj1.getByEmpId(123);
		// System.out.println(internalAuth.getEmp_id()+" "
		// +internalAuth.getTrans_id()+" "+internalAuth.isAuth_state());
		//
		// Authorization_External authorizeExternal=new
		// Authorization_External();
		// authorizeExternal.setTrans_id(19823);
		// authorizeExternal.setAcc_id("12345");
		// authorizeExternal.setAuth(true);
		// AuthorizeExternalDao obj2 = ctx.getBean("authorizeExternalDao",
		// AuthorizeExternalDao.class);
		// obj2.saveOrUpdate(authorizeExternal);
		// Authorization_External externalAuth = obj2.getByTransactionId(19823);
		// System.out.println(externalAuth.getTrans_id()+" "+externalAuth.getAcc_id()+" "
		// +externalAuth.isAuth());
		//
		...
		// TransactionDao obj3 = ctx.getBean("transactions",
		// TransactionDao.class);
		// obj3.saveOrUpdate(transactions);
		// Transactions trans = obj3.getByTransactionId(19823);
		// System.out.println(trans.getTrans_id()+" "+trans.getAmount()+" "+
		// trans.getEmp_id()+" "+trans.getFrom_acc()+" "+ trans.getTo_acc()+" "
		// +trans.getInit_id()+" "+trans.getType()+" "+trans.isActive());
		//
		...
		// card.setCvv(333);
		// card.setType("Debit");
		// ClassPathXmlApplicationContext ctx4 = new
		// ClassPathXmlApplicationContext("users-bean.xml");
