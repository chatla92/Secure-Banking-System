...
public class ExternalRequestController {
    ...
    public String viewExternalRequest(Model model, HttpServletRequest request, RedirectAttributes redAttr) {
        if (request.getSession(false) != null) {
            try {
                ...
                if (RoleCheck.isExternal(role)) {
                    ...
                    return "redirect:/externalrequest";
                }
    ...
    @RequestMapping(value = "/externalrequest", method = RequestMethod.GET)
    public String getReq(Model model, HttpServletRequest request, RedirectAttributes redAttr){
        if (request.getSession(false) != null) {
            try {
                setUserDetails(request);
