...
<body>
	...
	<div class="section">
		...
		<form action="/securebank/log" method="get">
			<button type="submit" class="btn waves-effect waves-light left green accent-4" id="submit">Get Transaction Log</button>
		</form>
	</section>
        <div class="center">
                    <button type="button" class="btn waves-effect waves-light right green accent-4"
          ...
          <form action="/securebank/authorize/modify" method="get">
                  <button type="submit" class="btn waves-effect waves-light right green accent-4" id="submit">Authorize modifications</button>
          </form>
          </div>
            </div>
        </div>
      ...
      <div class="section container">
        <h5 class="center-align">Modify an employee's profile:</h5>
          <div>
              <div class="row"> <div class="input-field col s12"> <label for="account">Employee Id:</label> <input
                          id="account" type="text" maxlength="250" name="account">
                  </div> </div>
              <div class="row">
                          <button id="modify" type="button" class="btn waves-effect waves-light right green accent-4">
